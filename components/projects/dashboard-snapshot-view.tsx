...
// editor - this view must never disagree with what was approved there.
...
// Shared read-only renderer for a dashboard's header + metric-card grid, fed
// by whatever endpoint the caller points it at. The public share link
// (components/public/public-dashboard-view.tsx) and the staff "ver como
// cliente" preview both use this, so the two can never drift visually - the
// preview really does show what the public link would show.
export function DashboardSnapshotView({
  ...
  useEffect(() => {
    ...
    fetch(fetchUrl, { cache: "no-store" })
      ...
      .then((dashboard: DashboardSnapshot) => {
